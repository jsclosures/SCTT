    ...
    function validateQuery(doc,hasMore,ctx){
        ...
        if( topdocbefore && topdocbefore.indexOf("~") ){
            ...
            for(let recStr of docs){
                ...
                buffer += doc.query_txt  + "," + "PREPROD" + "," + rowcount + "," + rowcountb  + "," + recStr + "\n";
            }
            ctx.buffer += buffer;
        }
        else {
        ...
        if( topdocafter && topdocafter.indexOf("~") ){
            ...
            for(let recStr of docs){
                ...
                buffer += doc.query_txt  + "," + "PROD" + "," + rowcount + "," + rowcountb  + "," + recStr;
            }
            ctx.buffer += buffer;
        }
        else {
            buffer += doc.query_txt  + "," + "PROD" + "," + rowcount + "," + rowcountb  + "," + topdocafter;
        }
